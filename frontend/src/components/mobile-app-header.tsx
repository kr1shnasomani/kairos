...
export function MobileAppHeader({ onOpenMenu, onOpenSearch, onOpenCapture, onCreate, onOpenBriefs, onOpenUser, userInitial, notificationCount }: MobileAppHeaderProps) {
  return (
    <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center gap-1.5 border-b border-line bg-surface px-2 shadow-sm sm:gap-3 sm:px-4 md:hidden print:hidden">
      ...
      <button type="button" onClick={onOpenCapture} aria-label="Open field capture" className="grid size-10 shrink-0 place-items-center rounded-xl border border-line bg-page text-ink shadow-sm sm:size-11"><svg className="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true"><path d="M8 4v4m8-4v4M6 10h12M7 20h10a2 2 0 0 0 2-2V8H5v10a2 2 0 0 0 2 2Z" /><path d="m9 14 2 2 4-4" /></svg></button>
