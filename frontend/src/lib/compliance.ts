...
const gaps: ComplianceGap[] = [
  ...
  { concept_id: "REG-OISD-4.3", framework: "OISD_117", clause_id: "4.3", requirement_text: "Inspection interval within regulatory limit", authority_level: 2, asset_id: "HE-301", equipment_class: "Shell-and-tube exchanger", severity: "major" },
  ...
  { concept_id: "REG-ISO-10.2", framework: "ISO_45001", clause_id: "10.2", requirement_text: "Nonconformity and corrective-action tracking", authority_level: 3, asset_id: "HE-301", equipment_class: "Shell-and-tube exchanger", severity: "minor" },
];
